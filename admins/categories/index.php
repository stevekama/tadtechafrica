        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>" target="_blank">Home</a></li>
    ...
    $(document).ready(function() {
        function find_categories() {
            var dataTable = $('#loadCategories').DataTable({
                ...
                "order": [],
                "ajax": {
                    url: "http://localhost/tadtechafrica/api/categories/fetch.php",
                    type: "POST",
                },
                "autoWidth": false
            });
        ...
        $('#newCategoryForm').submit(function(event){
            ...
            if(category_image == ''){
                ...
                if(jQuery.inArray(extension, ['gif', 'png', 'jpg', 'jpeg']) == -1){
                    ...
                    $.ajax({
                        url:"http://localhost/tadtechafrica/api/categories/new_categoires.php",
                        type:"POST",
        ...
        $(document).on('click', '.edit', function(e){
            ...
            $.ajax({
                url:"http://localhost/tadtechafrica/api/categories/categories.php",
                type:"POST",
