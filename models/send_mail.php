...
class SendMail{
    ...
    public function send_mail()
    {
        ...
        try{
            ...
            $this->mail->Host       = 'mail.tadtechafrica.com';                       // Set the SMTP server to send through
            $this->mail->SMTPAuth   = true;                                   // Enable SMTP authentication
            $this->mail->Username   = 'info@tadtechafrica.com';                     // SMTP username
            $this->mail->Password   = 'tadtechafrica';                               // SMTP password
