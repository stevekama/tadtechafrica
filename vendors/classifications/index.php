...
$title = "Vendors || Product Classifications";
                ...
                <form id="newClassificationForm">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="classification" class="form-control" id="newClassificationName" placeholder="Enter classification name" />
                        </div>
