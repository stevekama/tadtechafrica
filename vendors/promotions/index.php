...
$page = "product_classifications";
$title = "Vendors || Product Promotions";
            ...
            <div class="modal-content">
                ...
                <form id="newProductPromotionForm">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="submit" id="newProductPromotionSubmitBtn" class="btn btn-success">Save</button>
                    </div>
                </form>
            </div>
            <!-- /.modal-content -->
    ...
    $(document).ready(function() {
        ...
        $('#newProductPromotionForm').submit(function(event) {
            ...
            $.ajax({
                ...
                dataType: "json",
                beforeSend: function() {
                    $("#newProductPromotionSubmitBtn").html('Loading..');
                },
