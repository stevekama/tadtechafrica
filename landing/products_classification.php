...
$classification_id = htmlentities($_GET['classification']);
...
// find all products 
$all_products = $products->find_products_by_classification_id($current_classification['id']);
?>
...
<div class="home">
    ...
    <div class="home_content d-flex flex-column align-items-center justify-content-center">
        <h2 class="home_title"><?php echo htmlentities($current_classification['classification']); ?> </h2>
    </div>
</div>
