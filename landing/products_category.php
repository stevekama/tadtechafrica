...
// find all products 
$all_products = $products->find_products_by_category_id($current_category['id']);
?>
...
<div class="home">
    ...
    <div class="home_content d-flex flex-column align-items-center justify-content-center">
        <h2 class="home_title"><?php echo htmlentities($current_category['category_name']); ?> Products</h2>
    </div>
</div>
