        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo base_url(); ?>admins/categories/index.php" class="nav-link">
                                <i class="fa fa-circle nav-icon"></i>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo base_url(); ?>admins/classifications/index.php" class="nav-link">
                                <i class="fa fa-circle nav-icon"></i>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo base_url(); ?>admins/promotions/index.php" class="nav-link">
                                <i class="fa fa-circle nav-icon"></i>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo base_url(); ?>admins/products/index.php" class="nav-link">
                                <i class="fa fa-circle nav-icon"></i>
                                <p>Products</p>
                            </a>
                        </li>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo base_url(); ?>admins/delivery/mode.php" class="nav-link">
                                <i class="fa fa-circle nav-icon"></i>
                                <p>Delivery Mode</p>
                            </a>
                        </li>
