...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="<?php echo public_url(); ?>back/dist/css/adminlte.min.css">
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-dark navbar-primary">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="<?php echo base_url(); ?>vendors/index.php" class="nav-link">Dashboard</a>
                </li>
            </ul>
            ...
            <!-- <div class="media">
                                <img src="<?php // echo public_url(); 
                                            ?>back/dist/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
            ...
            <!-- <div class="media">
                                <img src="<?php // echo public_url(); 
                                            ?>back/dist/img/user8-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        John Pierce
            ...
            <!-- <div class="media">
                                <img src="<?php // echo public_url(); 
                                            ?>back/dist/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        Nora Silvester
